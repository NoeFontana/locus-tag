...
- [ ] Code follows project's code style guidelines (as defined in `docs/engineering/`)
...
LOCUS_ICRA_DATASET_DIR=$(pwd)/tests/data/icra2020 \
...
- To run heavy tests explicitly, use the standard cargo test runner in release mode with required features: 
  `TRACY_NO_INVARIANT_CHECK=1 LOCUS_ICRA_DATASET_DIR=tests/data/icra2020 cargo test --release --test regression_icra2020 --features bench-internals`.
