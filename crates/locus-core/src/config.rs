...
#[cfg(feature = "profiles")]
const STANDARD_JSON: &str =
    include_str!("../../locus-py/locus/profiles/standard.json");
#[cfg(feature = "profiles")]
const GRID_JSON: &str = include_str!("../../locus-py/locus/profiles/grid.json");
#[cfg(feature = "profiles")]
const HIGH_ACCURACY_JSON: &str =
    include_str!("../../locus-py/locus/profiles/high_accuracy.json");
...
impl DetectorConfig {
    ...
    pub fn from_profile_json(json: &str) -> Result<Self, crate::error::ConfigError> {
        use crate::error::ConfigError;
        let parsed: profile_json::ProfileJson = serde_json::from_str(json)
            .map_err(|e| ConfigError::ProfileParse(e.to_string()))?;
