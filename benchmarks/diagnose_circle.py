...
def main():
    ...
    print(f"{'Image':<20} {'Quads':<8} {'Decoded':<8} {'Rate%':<8} {'Thresh(ms)':<10} {'Quad(ms)':<10} {'Decode(ms)':<10}")
    print("-" * 90)
    ...
    for img_path in images:
        ...
        if result:
            ...
            print(f"{result['image']:<20} {result['quads_extracted']:<8} {result['tags_decoded']:<8} {result['decode_rate']:<8.1f} {result['threshold_ms']:<10.2f} {result['quad_ms']:<10.2f} {result['decode_ms']:<10.2f}")
